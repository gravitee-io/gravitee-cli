...
func newCreateCmd(f *factory.Factory, domainID *string) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example: `  gio am form create --domain my-domain --file form.json
  gio am form create --domain my-domain -f form.json
  envsubst < form.json | gio am form create --domain my-domain`,
		Args: cobra.NoArgs,
