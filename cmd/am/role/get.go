...
func newGetCmd(f *factory.Factory, domainID *string) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example: `  gctl am role get my-role-id --domain my-domain
  gctl am role get my-role-id --domain my-domain -o json`,
...
func (o *getOptions) run() error {
	...
	data, err := f.AM().GetRole(*o.domainID, o.roleID)
	if err != nil {
		return err
	}
...
func printRoleDetail(p *printer.Printer, data []byte) error {
