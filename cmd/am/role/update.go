...
func newUpdateCmd(f *factory.Factory, domainID *string) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:   "update <roleID>",
		Short: "Update a role",
		Example: `  gctl am role update my-role-id --domain my-domain --name "New Name"
  gctl am role update my-role-id --domain my-domain --description "Updated description"`,
...
func (o *updateOptions) run() error {
	...
	data, err := f.AM().UpdateRole(*o.domainID, o.roleID, json.RawMessage(raw))
	if err != nil {
		return err
	}
