...
func newListCmd(f *factory.Factory) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example: `  gio page list --api 8a7b3c4d-1234-5678-abcd-ef0123456789
  gio page list --api 8a7b3c4d-1234-5678-abcd-ef0123456789 --all`,
		Args: cobra.NoArgs,
...
func (o *listOptions) fetchPage(f *factory.Factory, p *printer.Printer, page int) error {
	path := cmdutil.V2EnvPath(f, fmt.Sprintf("apis/%s/pages?%s", o.apiID, o.buildQuery(page)))

	data, err := f.Client.Get(path)
	if err != nil {
		return fmt.Errorf("page list failed: %w", err)
	}
...
func pageColumns() []printer.Column {
	return []printer.Column{
		...
		{Name: "Visibility", Value: func(i interface{}) string { return cmdutil.StringField(i, "visibility") }},
		{Name: "Published", Value: func(i interface{}) string { return boolField(i, "published") }},
