...
func newListCmd(f *factory.Factory) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example: `  gio member list --api 8a7b3c4d-1234-5678-abcd-ef0123456789
  gio member list --api 8a7b3c4d-1234-5678-abcd-ef0123456789 --all`,
		Args: cobra.NoArgs,
...
func (o *listOptions) fetchPage(f *factory.Factory, p *printer.Printer, page int) error {
	path := cmdutil.V2EnvPath(f, fmt.Sprintf("apis/%s/members?%s", o.apiID, o.buildQuery(page)))
...
func memberColumns() []printer.Column {
	return []printer.Column{
		{Name: "Display Name", Value: func(i interface{}) string { return cmdutil.StringField(i, "displayName") }},
