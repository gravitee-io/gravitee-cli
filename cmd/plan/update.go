...
func newUpdateCmd(f *factory.Factory) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example: `  gio plan update aaaa1111-2222-3333-4444-555566667777 --api 8a7b3c4d-1234-5678-abcd-ef0123456789 -f plan-updated.json`,
		...
		RunE: func(_ *cobra.Command, args []string) error {
			...
			if err := cmdutil.CheckReadOnly(f, "plan update"); err != nil {
				return err
			}
...
func runUpdate(f *factory.Factory, apiID, planID, file string) error {
	...
	if err != nil {
		return fmt.Errorf("plan update failed: %w", err)
	}
