...
func newUpdateCmd(f *factory.Factory) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example: `  gio apim page update aaaa1111-2222-3333-4444-555566667777 --api 8a7b3c4d-1234-5678-abcd-ef0123456789 -f page-updated.json`,
...
func runUpdate(f *factory.Factory, apiID, pageID, file string) error {
	...
	data, err := f.APIM().UpdatePage(apiID, pageID, body)
	if err != nil {
		return err
	}
