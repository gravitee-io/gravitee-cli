...
func newUpdateCmd(f *factory.Factory) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example: `  gctl apim plan update aaaa1111-2222-3333-4444-555566667777 --api /my/api -f plan-updated.json
  envsubst < plan-updated.json | gctl apim plan update aaaa1111-2222-3333-4444-555566667777 --api /my/api`,
...
func runUpdate(f *factory.Factory, apiID, planID, file string) error {
	...
	data, err := f.APIM().UpdatePlan(apiID, planID, body)
	if err != nil {
		return err
	}
