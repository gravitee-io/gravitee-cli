...
func newGetCmd(f *factory.Factory) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example: `  gctl apim plan get aaaa1111-2222-3333-4444-555566667777 --api /my/api`,
...
func runGet(f *factory.Factory, apiID, planID string) error {
	data, err := f.APIM().GetPlan(apiID, planID)
	if err != nil {
		return err
	}
