...
func newListCmd(f *factory.Factory) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:   "list --api <apiId>",
		Short: "List members of an API",
		Example: `  gio apim member list --api 8a7b3c4d-1234-5678-abcd-ef0123456789
  gio apim member list --api 8a7b3c4d-1234-5678-abcd-ef0123456789 --all`,
		Args: cobra.NoArgs,
...
func (o *listOptions) fetchPage(f *factory.Factory, p *printer.Printer, page int) error {
	resp, err := f.APIM().ListMembers(o.apiID, page, o.perPage)
	if err != nil {
		return err
	}
	...
	if err := p.PrintList(resp.Data, memberColumns()); err != nil {
		return err
	}
...
func (o *listOptions) fetchAll(f *factory.Factory, p *printer.Printer) error {
	allData, err := apim.FetchAllPages(func(page int) (*apim.PaginatedResponse, error) {
		return f.APIM().ListMembers(o.apiID, page, o.perPage)
	})
	if err != nil {
		return err
	}
	...
	if err := p.PrintList(allData, memberColumns()); err != nil {
		return err
	}
...
func memberColumns() []printer.Column {
	return []printer.Column{
		{Name: "Display Name", Value: func(i any) string { return cmdutil.StringField(i, "displayName") }},
		{Name: "Role", Value: roleField},
